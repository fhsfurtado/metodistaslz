...
<div class="col card mb-6">
    <form name="cadAgenda" method="POST" action="ops/incluir_membro.php">
        ...
        <div class="row">
            <div class="col-lg-3 form-group">
                ...
                <input type="date" class="form-control" name="inputDataConversao" id="inputDataConversao" aria-describedby="nome" placeholder="Idade" min="1910-01-01" max="<?echo date('Y-m-d');?>" required>
            </div>
            <div class="col-lg-3 form-group">
                <label for="nome">Data de Nascimento:</label>
                <input type="date" class="form-control" name="inputDataNasc" id="inputDataNasc" aria-describedby="nome" placeholder="Idade" min="1910-01-01" max="<?echo date('Y-m-d');?>" required>
            </div>
            <div class="col-lg-6 form-group">
                <label for="nome">Sexo</label></br>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="radioGender" id="radioGender1" value="1" checked>
                    <label class="form-check-label" for="exampleRadios1">
                        <img src="../img/male-icon.png" width="20" height="20" class="d-inline-block align-top" alt="Masculino"> Masculino
                    </label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="radioGender" id="radioGender0" value="0">
        ...
        <div class="row">
            <div class="col-lg-8 form-group" align="center">
                ...
                <input type="text" class="form-control" name="inputEndereco" id="inputEndereco" aria-describedby="nome" placeholder="Rua, numero, bloco, apto..." required>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3 form-group">
                ...
                <input type="tel" class="form-control" name="inputFixo" id="inputFixo" aria-describedby="nome" placeholder="(XX)XXXX-XXXX" maxlength="15">
            </div>
            <div class="col-lg-3 form-group">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-outline-primary">Adicionar membro</button>
        </div>
    </form>
</div></br></br>