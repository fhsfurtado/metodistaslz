...
<body>
    ...
    <div class="card col-lg-6">
          ...
          <div class="card-body">
            <h5 class="card-title"><i class="fas fa-exclamation-triangle fa-lg"> Ops!</i></h5>
            <p class="card-text"><h6>Ocorreu algum erro!</h6></p>
            <p class="card-text"><h6>Tente novamente e, persistindo o erro, entre em contato conosco!</h6></p>
            <p class="card-footer">
            <?php
                if(isset($_SESSION)){
                    echo '<a href="../../index.php" class="btn btn-outline-dark rounded-pill"> Voltar pro Sistema</a>';
                    header( "refresh:6;url=../cms.php" );
                } else{
                    header( "refresh:10;url=../../index.php" );
                }
    
            ?>
                <a href="../../index.php" class="btn btn-outline-primary rounded-pill"> Voltar pro Site</a>
            </p>
          </div>
        </div>
    </div>
