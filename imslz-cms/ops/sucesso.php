...
<body>
    ...
    <div class="card col-lg-6">
          ...
          <div class="card-body">
            ...
            <p class="card-text"><h6>Você foi adicionada com sucesso à lista!</h6></p>
            <p class="card-text"><h6>Caso não possa comparecer, por favor informe o pastor para que possamos reabrir a vaga!</h6></p>
